...
Books-only this pass -- no comparison against deposited TDS challans yet
(Combined_PF_Statutory.py's extract_tds() already parses those; wiring a
deducted-vs-deposited reconciliation in is a follow-up phase).
"""
import datetime
import io
import os
...
page_header(
    ...
    badges=["As per books", "Party-wise & month-wise", "Inferred parties flagged"],
)
