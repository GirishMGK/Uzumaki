...
# Consolidate & Download routes (any report type) — require login
...
# Analytics hub (pick a dataset, then pick what to run) — require login
app.include_router(analytics_hub.router, prefix="", tags=["analytics-hub"])
